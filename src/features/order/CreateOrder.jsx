    ...
    <div>
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <div>
            <input
              className="w-full rounded-full border border-stone-200 px-4 py-2 text-sm transition-all duration-300 placeholder:text-stone-400 focus:ring focus:ring-yellow-400 focus:outline-none md:px-6"
              type="text"
              name="address"
              required
            />
...
export async function action({ request }) {
  ...
  /*If all required Form data is supplied and is valid (without errors), then an API POST request is made to create a new order and the customer will be redirected.*/
